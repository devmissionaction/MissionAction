...
export default function BuyButton({ slug }: { slug: string }) {
  ...
  return (
    <button
      onClick={handleBuy}         
      className="group bg-white p-8 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition duration-300 transform hover:-translate-y-1 text-center flex flex-col items-center w-full"
    >
